#!/usr/bin/env bash
# ASPOS Print Agent — Linux uninstaller
...
# ── 3. Service user ───────────────────────────────────────────────────────────
# Always removed. If a future deployment shares one machine across multiple
# agents, see AGENT-LIFECYCLE.md "Known limitations" for the --keep-user
...
log "Done. ASPOS Print Agent has been removed from this machine."
